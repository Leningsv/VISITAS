<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmpoliAdmin.aspx.cs" Inherits="Politicas_frmpoliAdmin" %>
                            ...
                            <tr>
                                <td style="width: 100%; text-align:left; background-color:#FFFFFF">                                                                                                     
                                            <asp:GridView ID="grdvDatos" SkinID="grillamant" runat="server" 
                                                ...
                                                Width="100%" AllowSorting="True" EmptyDataText="No Existen Políticas Ingresadas" 
                                                ForeColor="#333333" CellPadding="2" CssClass="Texto_General" AllowPaging="True" OnPageIndexChanging="grdvDatos_PageIndexChanging" DataKeyNames="Codigo"  > 
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Parametro" HeaderText="Políticas" >
