<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmrepVisitas.aspx.cs" Inherits="Reportes_frmrepVisitas" %>
                    ...
                    <tr>
                        <td style="text-align: center; ">
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="300px" Width="100%" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
                                <LocalReport ReportEmbeddedResource="pry_visita.Reportes.rptVisitas.rdlc" ReportPath="Reportes\repVisitas.rdlc">
                                    <DataSources>
                                        <rsweb:ReportDataSource DataSourceId="ods1" Name="DataSet1" />
                                    </DataSources>
                                </LocalReport>
                            </rsweb:ReportViewer>
                            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="Clone" TypeName="dsrepVisitas"></asp:ObjectDataSource>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: center; ">
