<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmrepPPL.aspx.cs" Inherits="Reportes_frmrepPPL" %>
                    ...
                    <tr>
                        <td style="text-align: center; ">
                            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Height="300px" Width="100%" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
                                <LocalReport ReportEmbeddedResource="pry_visita.Reportes.rptVisitas.rdlc" ReportPath="Reportes\repPPL.rdlc">
                                    <DataSources>
                                        <rsweb:ReportDataSource DataSourceId="ods1" Name="DataSet1" />
                                    </DataSources>
                                </LocalReport>
                            </rsweb:ReportViewer>
                            <asp:ObjectDataSource ID="ods1" runat="server" SelectMethod="Clone" TypeName="dsrepPPL"></asp:ObjectDataSource>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: center; ">
