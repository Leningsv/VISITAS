<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmciuNew.aspx.cs" Inherits="CiudadN_frmciuNew" %>
        ...
        <tr style="vertical-align: central">
            <td>
                <table runat="server" id="tblprincipal" style="width: 93%;  color: #000000;">
                    ...
                    <tr>
                        <td style="text-align: left; width: 69px; height: 18px;">
                    ...
                    <tr>
                        <td style="text-align: left; width: 69px; height: 18px;">
                            <asp:Label ID="lblnombres0" runat="server" Text="*Región:"></asp:Label>
                        </td>
                        <td style="height: 18px; text-align: left;">
                ...
                <asp:Label ID="lblerror" runat="server" Text="Ya existe la Ciudad Creada, por favor ingrese otra" ForeColor="Red" Visible="False" style="text-align: center"></asp:Label>
                        </td>
                    </tr>
                    </table>
            </td>
