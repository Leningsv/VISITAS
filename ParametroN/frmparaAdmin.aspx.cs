...
public partial class ParametroN_frmparaAdmin : System.Web.UI.Page
{
    #region variables
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                lbltitulo.Text = "Administrador de Parámetros";
                funCargarpost();
    ...
    {
        objparam[0] = 0;
        dsData = fun.consultarDatos("spnParaAdminReadAll", objparam, Page, (String[])Session["constrring"]);
    ...
    protected void btnselecc_Click(object sender, ImageClickEventArgs e)
    {
        ...
        String strCodigoParam = grdvDatos.DataKeys[intIndex].Values["Codigo"].ToString();
        Response.Redirect("frmparaEdit.aspx?paraCodigo=" + strCodigoParam);
    }
    #endregion
}