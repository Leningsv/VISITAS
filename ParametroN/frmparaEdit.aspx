<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmparaEdit.aspx.cs" Inherits="ParametroN_frmparaEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <hr />
    <asp:UpdatePanel ID="uppbuscagrilla" runat="server">
        <ContentTemplate>
            <table>
                    ...
                    <td>
                        <table runat="server" id="tblprincipal" style="width: 100%;  color: #000000;">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left">
                                    <asp:TextBox ID="txtdescrip" runat="server" Width="264px" MaxLength="255" CssClass="upperCase" Height="39px" TextMode="MultiLine" ></asp:TextBox>
                            ...
                            <tr>
                                <td style="text-align: left; width: 140px; height: 24px;">
                        ...
                        <asp:Label ID="lblerror" runat="server" Text="El nombre del Parámetro ingresado ya existe" ForeColor="Red" Visible="False"></asp:Label>
                    </td>
                                ...
                                <td style="width: 100%; text-align:left; background-color:#FFFFFF">                             
                                    <%--<asp:Panel ID="Panel2" runat="server" ScrollBars="Vertical" Height="320px" Width="100%"> --%>                              
                                        <asp:GridView ID="grdvDatos" runat="server" SkinID="grillamant" CaptionAlign="Left" 
                                            BackColor="White" EmptyDataText="No Existen Parámetros Ingresados" 
                                            Width="100%" AutoGenerateColumns="False" CellPadding="2" ForeColor="#333333" DataKeyNames="Codigo">
                                            <Columns>
                                        ...
                                        <table style="width: 100%">
                                            <tr>
                                                ...
                                                <td style="width: 226px">
                                                    <asp:ImageButton ID="btningresar" runat="server" Height="60px" ImageUrl="~/Botones/Nuevo.png" OnClick="btningresar_Click" CausesValidation="False" />
                                                </td>
