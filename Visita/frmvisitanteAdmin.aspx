<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmvisitanteAdmin.aspx.cs" Inherits="Visita_frmvisitanteAdmin" %>
                        ...
                        <tr>
                            <td style="width: 100%; text-align:left; background-color:#FFFFFF">  
                                ...
                                <asp:GridView ID="grdvDatos" SkinID="grillamant" runat="server" 
                                    ...
                                    ForeColor="#333333" CellPadding="4" CssClass="Texto_General" 
                                    AllowPaging="True" OnPageIndexChanging="grdvDatos_PageIndexChanging" OnSorting="Ordenar_GridView" DataKeyNames="TipoDoc,Documento,Visitante,Estado,URLLINK"  > 
                                    <Columns>
                                        <asp:HyperLinkField DataNavigateUrlFields="URLLINK" DataTextField="TipoDoc" HeaderText="Tipo Documento" SortExpression="TipoDoc" >
                                            <ControlStyle ForeColor="Black" Font-Size="7pt" />
                                            <HeaderStyle CssClass="GVFixedHeader" Width="150px" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:HyperLinkField>
                                        <asp:HyperLinkField DataNavigateUrlFields="URLLINK" DataTextField="Documento" HeaderText="No. Documento" SortExpression="Documento">
                                            <ControlStyle ForeColor="Black" Font-Size="7pt" />
                                            <HeaderStyle CssClass="GVFixedHeader"  Width="150px"/>
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:HyperLinkField>
                                        <asp:HyperLinkField DataNavigateUrlFields="URLLINK" DataTextField="Visitante" HeaderText="Visitante" SortExpression="Visitante">
                                            <ControlStyle ForeColor="Black" Font-Size="7pt" />
                                            <HeaderStyle CssClass="GVFixedHeader" Width="450px" />
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:HyperLinkField>
                                        <asp:HyperLinkField DataNavigateUrlFields="URLLINK" DataTextField="Estado" HeaderText="Estado" SortExpression="Estado">
                                            <ControlStyle ForeColor="Black" Font-Size="7pt" />
