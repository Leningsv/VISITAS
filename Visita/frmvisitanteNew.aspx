<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmvisitanteNew.aspx.cs" Inherits="Visita_frmvisitanteNew" %>
                        ...
                        <ContentTemplate>
                            ...
                            <table style="width: 100%; color:black">
                                <tr>
                                    ...
                                    <td style="text-align: left; width: 413px;">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left; width: 413px;">
                                        <asp:TextBox ID="txttelefono" runat="server" CssClass="upperCase" MaxLength="30" Width="264px"></asp:TextBox>
