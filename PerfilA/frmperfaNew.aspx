<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmperfaNew.aspx.cs" Inherits="PerfilA_frmperfaNew" %>
                    ...
                    <td style="border-style: double groove groove double; width: 100%; border-top-width: 1px; border-top-color: #FFFFFF; border-left-width: 1px; border-left-color: #FFFFFF; ">
                        <table runat="server" id="tblprincipal" style="width: 100%;  color: #000000;">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left; width: 298px;">
                                    <asp:CheckBox ID="chkestado" runat="server" Checked="True" Text="Activo" Enabled="False" />
                                </td>
                                ...
                                <td style="width: 100%; text-align:left; background-color:#FFFFFF">                             
                                    <%--<asp:Panel ID="Panel2" runat="server" ScrollBars="Vertical" Height="180px" Width="100%">--%>                               
                                        <asp:GridView ID="grdvDatos" runat="server" 
                                            ...
                                            ForeColor="#333333" CellPadding="2" PageSize="15" CssClass="Texto_General" OnSelectedIndexChanged="grdvDatos_SelectedIndexChanged" DataKeyNames="CodigoLoc,CodigoCRS"  > 
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Mostrar Equipos">
                                                    <HeaderStyle CssClass="GVFixedHeader" />
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="btnselecc" runat="server" Height="25px" ImageUrl="~/Botones/seleccionar.png" CausesValidation="False" OnClick="btnselecc_Click" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                ...
                                <td style="width: 100%; text-align:left; background-color:#FFFFFF">  
                                    ...
                                    <%--<asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" Height="180px" Width="100%">--%> 
                                        <asp:GridView ID="grdvDetalle" runat="server" 
                                                ...
                                                ForeColor="#333333" CellPadding="2" PageSize="15" CssClass="Texto_General" OnRowDataBound="grdvDetalle_RowDataBound" DataKeyNames="CodigoEqu"  > 
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Seleccionar">
                                                        <ItemTemplate>
