<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmperfaAdmin.aspx.cs" Inherits="PerfilA_frmperfaAdmin" %>
                            ...
                            <tr>
                                <td style="width: 100%; text-align:left; background-color:#FFFFFF">
                                            ...
                                            <asp:GridView ID="grdvDatos" SkinID="grillamant" runat="server" 
                                                ...
                                                Width="100%" AllowSorting="True" EmptyDataText="No existen Perfiles Creados" 
                                                ForeColor="#333333" 
                                                DataKeyNames="Codigo,Perfil,Descripcion,Estado,URLLINK" CellPadding="4" CssClass="Texto_General" OnSorting="grdvDatos_Sorting" AllowPaging="True" > 
                                                <Columns>
                                                    <asp:HyperLinkField DataNavigateUrlFields="URLLINK" DataTextField="Codigo" SortExpression="Codigo" HeaderText="Codigo" Target="_self" Visible="false" >
                                                        <ControlStyle ForeColor="Black" Font-Size="7pt" />
                                                        <HeaderStyle CssClass="GVFixedHeader" />
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:HyperLinkField>
                                                    <asp:HyperLinkField DataNavigateUrlFields="URLLINK" DataTextField="Perfil" HeaderText="Perfil" SortExpression="Perfil">
                                                        <ControlStyle ForeColor="Black" Font-Size="7pt" />
                                                        <HeaderStyle CssClass="GVFixedHeader" />
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:HyperLinkField>
                                                    <asp:HyperLinkField DataNavigateUrlFields="URLLINK" HeaderText="Descripción" DataTextField="Descripcion" >
                                                        <ControlStyle ForeColor="Black" Font-Size="7pt" />
                                                        <HeaderStyle CssClass="GVFixedHeader" />
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:HyperLinkField>
