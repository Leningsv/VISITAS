<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmmenuAdmin.aspx.cs" Inherits="MenuN_frmmenuAdmin" %>
                                    ...
                                    <asp:UpdatePanel ID="uppbuscagrilla" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>     
                                            ...
                                            <asp:GridView ID="grdvDatos" SkinID="grillamant" runat="server" 
                                                ...
                                                ForeColor="#333333" 
                                                DataKeyNames="Codigo" CellPadding="2" CssClass="Texto_General" AllowPaging="True" OnPageIndexChanging="grdvDatos_PageIndexChanging"  > 
                                                <Columns>
