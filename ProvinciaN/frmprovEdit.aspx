<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmprovEdit.aspx.cs" Inherits="ProvinciaN_frmprovEdit" %>
        ...
        <tr style="vertical-align: central">
            <td>
                <table runat="server" id="tblprincipal" style="width: 91%;  color: #000000;">
                    ...
                    <tr>
                        <td style="text-align: left; width: 55px; height: 18px;">
