<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmplaAdmin.aspx.cs" Inherits="Planificador_frmplaAdmin" %>
                                    ...
                                    <asp:UpdatePanel ID="uppbuscagrilla" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>     
                                            ...
                                            <asp:GridView ID="grdvDatos" SkinID="grillamant" runat="server" 
                                                ...
                                                Width="100%" AllowSorting="True" EmptyDataText="No Existen Planificaciones Ingresadas" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:HyperLinkField DataNavigateUrlFields="URLLINK" DataTextField="Fecha" HeaderText="Fecha">
                                                        <ControlStyle ForeColor="Black" Font-Size="7pt" />
