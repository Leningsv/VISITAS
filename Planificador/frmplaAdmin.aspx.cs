...
public partial class Planificador_frmplaAdmin : System.Web.UI.Page
{
    #region Variables
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                lbltitulo.Text = "Administrador de Planificaciones";
                funCargaMantenimiento();
                if (Request["mensajeRetornado"] != null)
                {
                    SIFunBasicas.Basicas.PresentarMensaje(Page, "::PLANIFICADOR::", Request["MensajeRetornado"]);
                }
            }
            else
            {
    ...
    protected void funCargaMantenimiento()
    {
        ...
        objparam[0] = 0;
        dsData = fun.consultarDatos("spCarPlanificadores", objparam, Page, (String[])Session["constrring"]);
    ...
    {
        Response.Redirect("~/Planificador/frmplaNew.aspx");
    }
