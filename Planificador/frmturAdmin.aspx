<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmturAdmin.aspx.cs" Inherits="Planificador_frmturAdmin" %>
                                        ...
                                        <ContentTemplate>     
                                            ...
                                            <asp:GridView ID="grdvDatos" SkinID="grillamant" runat="server" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Turno" HeaderText="Turnos" >
                                                        <ControlStyle ForeColor="Black" Font-Size="7pt" />
                                                        <HeaderStyle CssClass="GVFixedHeader" />
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:BoundField>
