<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmingresonuevoVisitante.aspx.cs" Inherits="VisitaPPL_frmingresonuevoVisitante" %>
                ...
                <table style="width: 100%; color: #000000;">
                    ...
                    <tr>
                        <td colspan="6" style="height: 19px; text-align: left;">
                            ...
                            <a href="frmingresonuevoVisitante.aspx"><span style="color: #000000">frmingresonuevoVisitante.aspx</span></a></td>
                    </tr>
                </table>
            </div>
            <hr />
                    ...
                    <td style="width: 90%">
                        <table style="width: 100%; color: black">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left">
                                    <asp:TextBox ID="txtnombre1" runat="server" CssClass="upperCase" MaxLength="180" Width="264px" Enabled="False"></asp:TextBox>
                                </td>
                                <td style="text-align: left">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left">
                                    <asp:TextBox ID="txttelefono" runat="server" CssClass="upperCase" Enabled="False" MaxLength="16" Width="264px"></asp:TextBox>
                                </td>
                                <td style="text-align: left">
                                    &nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left">
                                    <asp:DropDownList ID="ddlparentesco" runat="server" Enabled="False" Width="267px">
                                    </asp:DropDownList>
                                </td>
                                <td style="text-align: left">&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left">
                                    <asp:TextBox ID="txtnombre2" runat="server" CssClass="upperCase" Enabled="False" MaxLength="30" Width="264px" Visible="False"></asp:TextBox>
                                </td>
                                <td style="text-align: left">
                                    &nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left">
                                    <asp:TextBox ID="txtapellido1" runat="server" CssClass="upperCase" Enabled="False" MaxLength="30" Width="264px" Visible="False"></asp:TextBox>
                                </td>
                                <td style="text-align: left">&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left">
                                    <asp:TextBox ID="txtapellido2" runat="server" CssClass="upperCase" Enabled="False" MaxLength="30" Width="264px" Visible="False"></asp:TextBox>
                                </td>
                                <td style="text-align: left">&nbsp;</td>
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td style="width: 1590px">
                                <asp:ImageButton ID="btngrabar" runat="server" Height="60px" ImageUrl="~/Botones/Ingresar.png" OnClick="btngrabar_Click" />
                            </td>
                            ...
                            <td style="width: 899px">
                                <asp:ImageButton ID="btnhuella" runat="server" Height="60px" ImageUrl="~/Botones/verificarHuella.png" OnClick="btnhuella_Click" CausesValidation="False" />
                            </td>
