<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmvistpplCamaraNew.aspx.cs" Inherits="VisitaPPL_frmvistpplCamaraNew" %>
                    ...
                    <td style="width: 90%">
                        <table style="width: 100%; color: black">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left">
                                    <asp:TextBox ID="txtnombre2" runat="server" CssClass="upperCase" Enabled="False" MaxLength="30" Visible="False" Width="264px"></asp:TextBox>
                                </td>
                                <td style="text-align: left">&nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td style="text-align: left">
                                    <asp:TextBox ID="txtapellido1" runat="server" CssClass="upperCase" Enabled="False" MaxLength="30" Visible="False" Width="264px"></asp:TextBox>
                                </td>
                                <td style="text-align: left">&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left">
                                    <asp:TextBox ID="txtapellido2" runat="server" CssClass="upperCase" Enabled="False" MaxLength="30" Visible="False" Width="264px"></asp:TextBox>
                                </td>
                                <td style="text-align: left">&nbsp;</td>
            ...
            <td>
                <div id="menuaccions" style="border-style: ridge double double ridge; width: 100%; background-color: #FFFFFF; border-top-width: 4px; border-top-color: #FF0000; border-left-color: #FF0000;">
                    <table style="width: 100%">
                        <tr>
                            <td style="width: 1548px">
                                <asp:ImageButton ID="btngrabar" runat="server" Height="60px" ImageUrl="~/Botones/Ingresar.png" OnClick="btningresar" />
                            </td>
