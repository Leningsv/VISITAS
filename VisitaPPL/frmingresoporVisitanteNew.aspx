<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmingresoporVisitanteNew.aspx.cs" Inherits="VisitaPPL_frmingresoporVisitanteNew" %>
            ...
            <table style="width: 100%; color: black">
                    ...
                    <td style="width: 90%">
                        <table style="width: 100%; color: black">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left">
                                    <asp:TextBox ID="txtnombre1" runat="server" CssClass="upperCase" MaxLength="180" Width="264px"></asp:TextBox>
                                </td>
                                <td style="text-align: left">
                            ...
                            <tr>
                                <td style="text-align: left; width: 21px;">&nbsp;</td>
                                <td style="text-align: left; width: 145px;">
                                    <asp:Label ID="Label22" runat="server" Text="Género:"></asp:Label>
                                </td>
                                <td style="text-align: left">
                                    <asp:DropDownList ID="ddlgenero" runat="server" OnSelectedIndexChanged="ddltipodoc_SelectedIndexChanged" Width="267px">
                                    </asp:DropDownList>
                                </td>
                ...
                <tr>
                    ...
                    <td style="width: 90%; text-align: left;">
                        <asp:Label ID="lblmsj2" runat="server" ForeColor="Red" Text="Label" Visible="False"></asp:Label>
                    </td>
                    <td>&nbsp;</td>
                </tr>
            </table>
                    ...
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="width: 899px">
                                <asp:ImageButton ID="btnhuella" runat="server" Height="60px" ImageUrl="~/Botones/huella.png" OnClick="btnhuella_Click" CausesValidation="False" />
                            </td>
