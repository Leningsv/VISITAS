<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmingreVisiHuella.aspx.cs" Inherits="VisitaPPL_frmingreVisiHuella" %>
                        ...
                        <table style="width: 100%; color: black">
                            <tr>
                                ...
                                <td style="width: 153px; text-align: left;">
                                    ...
                                    <asp:CheckBox ID="chkmenor" runat="server" Text="Menor de Edad" AutoPostBack="True" />
                    ...
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="width: 966px">
                                <asp:ImageButton ID="btnhuella" runat="server" Height="60px" ImageUrl="~/Botones/huella.png" OnClick="btnhuella_Click" />
                            </td>
