...
public partial class VisitaPPL_frmingresoporVisitante : System.Web.UI.Page
{
    #region Variables
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (dsData.Tables[0].Rows[0][0].ToString() == "SI") btnverificar.Visible = true;
    ...
    protected void btnverificar_Click(object sender, ImageClickEventArgs e)
    {
        Session["redirecc"] = "2";
    ...
    strHoraHasta = "";
        ...
        //VERIFICAR HUELLA SI EL 
        if (Session["verificarHuella"].ToString() == "SI")
        {
            ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Componente para Verificar la Huella');", true);
        }
        ...
        dsData = fun.consultarDatos("spInserEventoVerifica", objparam, Page, (String[])Session["constrring"]);
