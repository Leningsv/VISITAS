<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmsalidavisNew.aspx.cs" Inherits="SalidaVisita_frmsalidavisNew" %>
                        ...
                        <ContentTemplate>
                            ...
                            <table style="width: 100%; color:black">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left; width: 145px;">
                                        <asp:Label ID="Label15" runat="server" Text="Visito a PPL:"></asp:Label>
                                    </td>
                                    <td style="text-align: left">
                                        <asp:TextBox ID="txtppl" runat="server" Enabled="False" MaxLength="16" Width="264px"></asp:TextBox>
                                    </td>
                ...
                <td>
                    <div id="menuaccions" style="border-style: ridge double double ridge; width: 100%; background-color: #FFFFFF; border-top-width: 4px; border-top-color: #FF0000; border-left-color: #FF0000;">
                        <table style="width: 100%">
                            <tr>
                                <td style="width: 25%">
                                    <asp:ImageButton ID="btngrabar" runat="server" Height="45px" ImageUrl="~/Botones/permitir_salida.png" OnClick="btngrabar_Click" />
                                </td>
                                <td style="width: 25%">
