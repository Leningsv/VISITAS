<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmsancionEdit.aspx.cs" Inherits="Sancion_frmsancionEdit" %>
                ...
                <table runat="server" id="tblprincipal" style="width: 100%;  color: #000000;">
                    <tr>
                        <td style="text-align: right; width: 326px;">
                            <asp:Label ID="Label7" runat="server" Text="Código:" Visible="False"></asp:Label>
                        </td>
                        <td style="text-align: left; width: 408px;">
                            <asp:TextBox ID="txtcodigo" runat="server" Width="264px" MaxLength="100" Enabled="False" Visible="False" ></asp:TextBox>
                        </td>
