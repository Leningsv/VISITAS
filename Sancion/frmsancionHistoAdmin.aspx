<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmsancionHistoAdmin.aspx.cs" Inherits="Sancion_frmsancionHistoAdmin" %>
                                ...
                                <td style="width: 100%; text-align:left; background-color:#FFFFFF">
                                    <%--<asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" Width="100%" Height="320px">--%>
                                        <asp:GridView ID="grdvDatos" SkinID="grillamant" runat="server" 
                                                ...
                                                CssClass="Texto_General" AllowPaging="True" DataKeyNames="Codigo" OnPageIndexChanging="grdvDatos_PageIndexChanging" > 
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Cantidad" HeaderText="Cant. Sancion" >
                                                        <ControlStyle ForeColor="Black" Font-Size="7pt" />
                                                        <HeaderStyle CssClass="GVFixedHeader" />
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:BoundField>
