<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmsanDatosHistDeta.aspx.cs" Inherits="Sancion_frmsanDatosHistDeta" %>
    ...
    <table style="width: 100%; height: 100%">
        <tr style="vertical-align: top">
            <td style="border-style: double groove groove double; width: 100%; border-top-width: 1px; border-top-color: #FFFFFF; border-left-width: 1px; border-left-color: #FFFFFF; ">
                <div class="buscador" style="height:80px; width:100%; background-color: #F4F4F4;">
                ...
                <table runat="server" id="Table1" style="width: 100%;  color: #000000;">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left; width: 309px; height: 19px;">
                            <asp:TextBox ID="txtsancionado" runat="server" Width="264px" MaxLength="30" CssClass="upperCase" Enabled="False"></asp:TextBox>
                        </td>
                        <td style="text-align: left; width: 326px; height: 19px;">
                            </td>
                ...
                <table runat="server" id="Table2" style="width: 100%;  color: #000000;">
                    ...
                    <tr>
                        <td style="text-align: right; width: 275px;">
                            &nbsp;</td>
                        <td style="text-align: left; width: 326px;">
                            <asp:Label ID="Label23" runat="server" Text="Ejecutado Por:"></asp:Label>
                        </td>
                        <td style="text-align: left; width: 309px;">
                            <asp:TextBox ID="txtejecutado" runat="server" Width="264px" MaxLength="30" CssClass="upperCase" Enabled="False"></asp:TextBox>
                        </td>
                        <td style="text-align: left; width: 309px;">
                            &nbsp;</td>
                        <td style="text-align: right; width: 326px;">
                ...
                <table runat="server" id="Table3" style="width: 100%;  color: #000000;">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left; width: 385px;">
                            <asp:TextBox ID="txtfechaefect" runat="server" Width="264px" MaxLength="16" AutoPostBack="True" Enabled="False"></asp:TextBox>
                    ...
                    <tr>
                        <td style="text-align: right; width: 275px; height: 26px;">
                            </td>
                        <td style="text-align: right; width: 440px; height: 26px;">
                            </td>
                        <td style="text-align: left; width: 438px; height: 26px;">
                            <asp:Label ID="Label24" runat="server" Text="Desbloqueado Por:"></asp:Label>
                        </td>
                        <td style="text-align: left; width: 385px; height: 26px;">
                            <asp:TextBox ID="txtdesblopor" runat="server" Width="264px" MaxLength="16" AutoPostBack="True" Enabled="False"></asp:TextBox>
                        </td>
                        <td style="text-align: left; width: 326px; height: 26px;">
                            </td>
                        <td style="text-align: left; width: 253px; height: 26px;">
                            </td>
                        <td style="text-align: left; width:275px; height: 26px;" >
                            </td>
                    </tr>
                    <tr>
                        <td style="text-align: right; width: 275px; height: 19px;">
                        ...
                        <td style="text-align: left; height: 19px;" colspan="4">
                            <asp:TextBox ID="txtobserva2" runat="server" Width="500px" MaxLength="255" CssClass="upperCase" TextMode="MultiLine" Enabled="False"></asp:TextBox>
                        </td>
                        <td style="text-align: left; height: 19px;">
                            </td>
                    </tr>
