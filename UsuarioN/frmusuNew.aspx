<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmusuNew.aspx.cs" Inherits="UsuarioN_frmusuNew" %>
                ...
                <table runat="server" id="tblprincipal" style="width: 100%;  color: #000000;">
                    <tr>
                        ...
                        <td style="text-align: left">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="ddldepartamento" ErrorMessage="Campor Requerido!" ForeColor="Red"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: left; width: 136px; height: 18px;">
                    ...
                    <tr>
                        ...
                        <td style="height: 18px; text-align: left;">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="ddlperfil" ErrorMessage="Campor Requerido!" ForeColor="Red"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: left; width: 136px;">
