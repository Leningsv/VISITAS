...
public partial class Policias_frmingPoliciaAdmin : System.Web.UI.Page
{
    #region Variables
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                lbltitulo.Text = "Administrador de Policías";
                funCargaMantenimiento();
                if (Request["mensajeRetornado"] != null)
                    SIFunBasicas.Basicas.PresentarMensaje(Page, "::POLICIA::", Request["MensajeRetornado"]);
            }
            else
            {
    ...
    protected void funCargaMantenimiento()
    {
        ...
        objparam[0] = 0;
        dsData = fun.consultarDatos("spCarPoliciasPreIng", objparam, Page, (String[])Session["constrring"]);
    ...
    {
        Response.Redirect("~/Policias/frmingPoliciaNew.aspx");
    }
    #endregion
