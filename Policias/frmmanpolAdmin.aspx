<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmmanpolAdmin.aspx.cs" Inherits="Policias_frmmanpolAdmin" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <table style="width: 100%; height: 80px">
                <tr>
                    <td>
                        <div class="buscador" style="height:58px; width:1000px; background-color: #F4F4F4;">
            ...
            <table style="height:100%; width:100%">
                <tr style="vertical-align:top">
                    <td style="height: 560px; ">
                        ...
                        <table runat="server" id="tblprincipal" style="width:80%">
                            <tr>
                                <td style="width: 1017px; text-align:left; background-color:#FFFFFF">
                                    <asp:UpdatePanel ID="uppbuscagrilla" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>     
                                            ...
                                            <asp:GridView ID="grdvDatos" SkinID="grillamant" runat="server" 
                                                ...
                                                Width="1000px" AllowSorting="True" EmptyDataText="No Existen Policías Ingresados" 
