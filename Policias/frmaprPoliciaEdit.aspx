<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmaprPoliciaEdit.aspx.cs" Inherits="Policias_frmaprPoliciaEdit" %>
                            ...
                            <table style="width: 100%; color:black">
                                <tr>
                                    ...
                                    <td style="text-align: left; width: 120px;">
                                        ...
                                        <asp:DropDownList ID="ddlTipoDocumento" runat="server" Width="267px" Enabled="False">
                                        </asp:DropDownList>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left; width: 120px;">
                                        <asp:TextBox ID="txtNroDoc" runat="server" AutoPostBack="True" MaxLength="16" Width="260px" Enabled="False"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left; width: 120px;">
                                        <asp:TextBox ID="txtnombres" runat="server" CssClass="upperCase" Height="19px" MaxLength="30" Width="260px" Enabled="False"></asp:TextBox>
                                    </td>
                                    <td style="text-align: left">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left; width: 120px;">
                                        <asp:TextBox ID="txtapellidos" runat="server" CssClass="upperCase" Height="19px" MaxLength="30" Width="260px" Enabled="False"></asp:TextBox>
                                    </td>
                                    <td style="text-align: left">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left; width: 120px;">
                                        <asp:TextBox ID="txtFechaNac" runat="server" Width="260px" Enabled="False"></asp:TextBox>
                                        ...
                                        <ajaxToolkit:MaskedEditExtender ID="txtFechaNac_MaskedEditExtender2" runat="server" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True" Mask="99/99/9999" MaskType="Date" TargetControlID="txtFechaNac">
                                        </ajaxToolkit:MaskedEditExtender>
                                        <ajaxToolkit:CalendarExtender ID="txtFechaNac_CalendarExtender2" runat="server" Enabled="True" Format="dd/MM/yyyy" TargetControlID="txtFechaNac">
                                        </ajaxToolkit:CalendarExtender>
                                    </td>
                                    <td style="text-align: left">
                                        &nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left; width: 120px;">
                                        <asp:TextBox ID="txtCelular" runat="server" CssClass="upperCase" Height="19px" MaxLength="80" Width="260px" Enabled="False"></asp:TextBox>
                                    </td>
                                    <td style="text-align: left">
                                        &nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left; width: 120px;">
                                        <asp:TextBox ID="txtFechaIng" runat="server" Width="260px" Enabled="False"></asp:TextBox>
                                        ...
                                        <ajaxToolkit:MaskedEditExtender ID="txtFechaIng_MaskedEditExtender2" runat="server" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True" Mask="99/99/9999" MaskType="Date" TargetControlID="txtFechaIng">
                                        </ajaxToolkit:MaskedEditExtender>
                                        <ajaxToolkit:CalendarExtender ID="txtFechaIng_CalendarExtender2" runat="server" Enabled="True" Format="dd/MM/yyyy" TargetControlID="txtFechaIng">
                                        </ajaxToolkit:CalendarExtender>
                                    </td>
                                    <td style="text-align: left">
                                        &nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left; height: 19px; width: 120px;">
                                        <asp:TextBox ID="txtFechaSal" runat="server" Width="260px" Enabled="False"></asp:TextBox>
                                        ...
                                        <ajaxToolkit:MaskedEditExtender ID="txtFechaSal_MaskedEditExtender2" runat="server" CultureAMPMPlaceholder="" CultureCurrencySymbolPlaceholder="" CultureDateFormat="" CultureDatePlaceholder="" CultureDecimalPlaceholder="" CultureThousandsPlaceholder="" CultureTimePlaceholder="" Enabled="True" Mask="99/99/9999" MaskType="Date" TargetControlID="txtFechaSal">
                                        </ajaxToolkit:MaskedEditExtender>
                                        <ajaxToolkit:CalendarExtender ID="txtFechaSal_CalendarExtender2" runat="server" Enabled="True" Format="dd/MM/yyyy" TargetControlID="txtFechaSal">
                                        </ajaxToolkit:CalendarExtender>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left; width: 120px;">
                                        <asp:DropDownList ID="ddlRango" runat="server" Width="267px" Enabled="False">
                                        </asp:DropDownList>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left; width: 120px;">
                                        <asp:DropDownList ID="ddlArea" runat="server" Width="267px" Enabled="False">
                                        </asp:DropDownList>
                                    </td>
                                    <td style="text-align: left">&nbsp;</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left; width: 21px;">
                                        &nbsp;</td>
                                    <td style="text-align: left; width: 145px;">
                                        <asp:Label ID="Label12" runat="server" Text="Acceso:"></asp:Label>
                                    </td>
                                    <td style="text-align: left; width: 120px;">
                                        <asp:DropDownList ID="ddlAcceso" runat="server" Width="267px">
                                        </asp:DropDownList>
                                    </td>
                                    <td style="text-align: left">
                                        <asp:Button ID="btVerEquipos" runat="server" Font-Size="X-Small" Height="20px" OnClick="btVerEquipos_Click" Text="ver equipos" Width="65px" />
                                    </td>
                                </tr>
                            </table>
                ...
                <td>
                    <div id="menuaccions" style="border-style: ridge double double ridge; width: 100%; background-color: #FFFFFF; border-top-width: 4px; border-top-color: #FF0000; border-left-color: #FF0000;">
                        <table style="width: 100%">
                            <tr>
                                <td style="width: 33%">
                                    <asp:ImageButton ID="btngrabar" runat="server" Height="60px" ImageUrl="~/Botones/Aprobar.png" Visible="False" OnClick="btngrabar_Click" />
                                </td>
                                <td style="width: 33%">
                                    <asp:ImageButton ID="btnRechazar" runat="server" Height="60px" ImageUrl="~/Botones/Rechazar.png" CausesValidation="False" OnClick="btnRechazar_Click" />
                                </td>
                                <td style="width:34%">
