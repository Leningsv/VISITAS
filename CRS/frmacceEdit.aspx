<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmacceEdit.aspx.cs" Inherits="CRS_frmacceEdit" %>
                        ...
                        <table runat="server" id="tblprincipal" style="width: 100%;  color: #000000;">
                            ...
                            <tr>
                                ...
                                <td style="height: 18px; text-align: left;">
                                    ...
                                    <asp:MaskedEditExtender ID="txtcodigo_MaskedEditExtender" runat="server" ClearMaskOnLostFocus="true" ClearTextOnInvalid="True" Enabled="True" Mask="9999" TargetControlID="txtcodigo">
                        ...
                        <table style="width: 100%; color:black" border="1" runat="server" id="tblequipos">
                            ...
                            <tr>
                                <td colspan="5" style="text-align: center">
                                    <asp:ImageButton ID="btnagregar" runat="server" CausesValidation="False" Height="50px" ImageUrl="~/Botones/i_agregar.png" OnClick="btnagregar_Click" />
                                    <asp:ImageButton ID="btneditar" runat="server" CausesValidation="False" Height="50px" ImageUrl="~/Botones/i_editar.png" OnClick="btneditar_Click" Visible="False" />
                                    <asp:ImageButton ID="btneliminar" runat="server" CausesValidation="False" Height="50px" ImageUrl="~/Botones/ii_eliminar.png" OnClick="btneliminar_Click" Visible="False" />
