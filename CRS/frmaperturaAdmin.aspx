<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmaperturaAdmin.aspx.cs" Inherits="CRS_frmaperturaAdmin" %>
                                ...
                                <td style="width: 100%; text-align:left; background-color:#FFFFFF">     
                                    ...
                                    <asp:Panel ID="Panel1" runat="server" Height="300px" ScrollBars="Vertical" Width="100%">                                                                                                    
                                            <asp:GridView ID="grdvDatos" SkinID="grillamant" runat="server" 
                                                ...
                                                PageSize="15" CssClass="Texto_General" AllowPaging="True" > 
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Seleccionar">
                                                        <HeaderStyle CssClass="GVFixedHeader" />
                                                        <ItemTemplate>
                                                            <asp:ImageButton ID="btnselec" runat="server" Height="25px" ImageUrl="~/Botones/seleccionar.png" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:BoundField DataField="TipoDoc" HeaderText="Nombre Acceso" >
                                        ...
                                        <table style="width: 100%">
                                            <tr>
                                                <td style="width: 385px">
                                                    <asp:ImageButton ID="btnnuevo" runat="server" Height="60px" ImageUrl="~/Botones/Nuevo.png" CausesValidation="False" />
                                                </td>
