<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmcrsEdit.aspx.cs" Inherits="CRS_frmcrsEdit" %>
            ...
            <td >
                <table runat="server" id="tblprincipal" style="width: 91%;  color: #000000;">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="txtcodigo" runat="server" CssClass="upperCase" MaxLength="80" Width="264px" Enabled="False" Visible="False"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: left; width: 102px; height: 18px;">
                    ...
                    <tr>
                        ...
                        <td style="height: 18px; text-align: left;">
                            <asp:TextBox ID="txtdireccion" runat="server" MaxLength="255" Width="264px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: left; width: 102px; height: 18px;">
