<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmrelacionparenAdmin.aspx.cs" Inherits="RelacionParentesco_frmrelacionparenAdmin" %>
                                    ...
                                    <%--<asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" Width="100%" Height="320px">--%>
                                        <asp:GridView ID="grdvDatos" SkinID="grillamant" runat="server" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="TipoVis" HeaderText="Tipo Visita" >
                                                        <ControlStyle ForeColor="Black" Font-Size="7pt" />
                                                        <HeaderStyle CssClass="GVFixedHeader" />
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:BoundField>
                                        ...
                                        <table style="width: 100%">
                                            <tr>
                                                <td style="width: 385px">
                                                    <asp:ImageButton ID="btnuevo" runat="server" Height="60px" ImageUrl="~/Botones/Nuevo.png" OnClick="btnuevo_Click"  />
                                                </td>
