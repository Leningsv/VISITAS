<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmrelacionparenEdit.aspx.cs" Inherits="RelacionParentesco_frmrelacionparenEdit" %>
                ...
                <table runat="server" id="tblprincipal" style="width: 100%;  color: #000000;">
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="txtcodigo" runat="server" Enabled="False" Width="264px" Visible="False"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: left; width: 136px;">
