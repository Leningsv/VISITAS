<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmvisitanteingresoNew.aspx.cs" Inherits="Funcionario_frmvisitanteingresoNew" %>
                            ...
                            <table style="width: 100%; color:black">
                                <tr>
                                    ...
                                    <td style="text-align: left; width: 145px;">
                                        <asp:Label ID="Label23" runat="server" Text="Código:" Visible="False"></asp:Label>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left">
                                        <asp:DropDownList ID="ddltipodoc" runat="server" AutoPostBack="True" Width="267px" OnSelectedIndexChanged="ddltipodoc_SelectedIndexChanged" Enabled="False">
                                        </asp:DropDownList>
                                    </td>
                                    <td style="text-align: left">
