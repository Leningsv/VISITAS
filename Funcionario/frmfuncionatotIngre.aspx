<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmfuncionatotIngre.aspx.cs" Inherits="Funcionario_frmfuncionatotIngre" %>
                        ...
                        <ContentTemplate>
                            ...
                            <table style="width: 100%; color:black">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left; width: 127px;">&nbsp;</td>
                                    <td style="text-align: left">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left">
                                        <asp:TextBox ID="txtcelular" runat="server" CssClass="upperCase" MaxLength="16" Width="264px"></asp:TextBox>
                                    <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtendercelular" runat="server" Enabled="True" FilterType="Numbers" TargetControlID="txtcelular">
                                        </asp:FilteredTextBoxExtender>
                                         </td>
                                    <td style="text-align: left">&nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left">
                                        <asp:TextBox ID="txtemail" runat="server" MaxLength="80" Width="264px"></asp:TextBox>
                                    </td>
                                    <td style="text-align: left">&nbsp;</td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="text-align: left">
                                        <asp:DropDownList ID="ddllugar" runat="server" Width="267px">
                                        </asp:DropDownList>
                                    </td>
                                    <td style="text-align: left">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="ddllugar" ErrorMessage="Campo Requerido!." ForeColor="Red"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align: left; width: 21px;">&nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="ddldepartamento" ErrorMessage="Campo Requerido!." ForeColor="Red"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align: left; width: 21px;">&nbsp;</td>
                                    ...
                                    <td style="text-align: left">
                                        <asp:TextBox ID="txtfechainicio"  CssClass="upperCase" runat="server" Width="264px" AutoPostBack="True" ></asp:TextBox>
                                    ...
                                    <td style="text-align: left">
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtfechainicio" ErrorMessage="Fecha Incorrecta!." ForeColor="Red" ValidationExpression="^(0[1-9]|[12][0-9]|3[01])[-/.](0[1-9]|1[012])[-/.](19|20)\d\d$"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align: left; width: 21px;">&nbsp;</td>
                                    ...
                                    <td style="text-align: left">
                                       <asp:TextBox ID="txtfechafin"  CssClass="upperCase" runat="server" Width="264px" AutoPostBack="True"></asp:TextBox>
                                    ...
                                    <td style="text-align: left">
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtfechafin" ErrorMessage="Fecha Incorrecta!." ForeColor="Red" ValidationExpression="^(0[1-9]|[12][0-9]|3[01])[-/.](0[1-9]|1[012])[-/.](19|20)\d\d$"></asp:RegularExpressionValidator>
                                    </td>         
                                </tr>
                                <tr>
                                    <td style="text-align: left; width: 21px;">&nbsp;</td>
