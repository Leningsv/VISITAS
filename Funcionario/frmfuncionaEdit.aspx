<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmfuncionaEdit.aspx.cs" Inherits="Funcionario_frmfuncionaEdit" %>
                        ...
                        <ContentTemplate>
                            ...
                            <table style="width: 100%; color:black">
                                ...
                                <tr>
                                    <td style="text-align: left; width: 21px;">&nbsp;</td>
                                    <td style="text-align: left; width: 145px;">
                                        <asp:Label ID="Label27" runat="server" Text="Autorizar Visitante:"></asp:Label>
                                    </td>
                                    <td style="text-align: left">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left; width: 145px; height: 40px;">
                                        <asp:Label ID="Label25" runat="server" Text="Estado:"></asp:Label>
                                    </td>
