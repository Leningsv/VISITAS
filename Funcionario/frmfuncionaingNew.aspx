<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmfuncionaingNew.aspx.cs" Inherits="Funcionario_frmfuncionaingNew" %>
                            ...
                            <table style="width: 100%; color:black">
                                <tr>
                                    ...
                                    <td style="text-align: left">
                                        ...
                                        <asp:DropDownList ID="ddltipodoc" runat="server" Width="267px" OnSelectedIndexChanged="ddltipodoc_SelectedIndexChanged" AutoPostBack="True">
                                        </asp:DropDownList>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left">
                                        <asp:TextBox ID="txtnombretemp" runat="server" CssClass="upperCase" visible="false" MaxLength="30" Width="382px"></asp:TextBox>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="ddldepartamento" ErrorMessage="Campo Requerido!." ForeColor="Red"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align: left; width: 21px;">&nbsp;</td>
                                    ...
                                    <td style="text-align: left">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="ddlcargo" ErrorMessage="Campo Requerido!." ForeColor="Red"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align: left; width: 21px;">&nbsp;</td>
                                    ...
                                    <td style="text-align: left">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="ddltipofun" ErrorMessage="Campo Requerido!." ForeColor="Red"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align: left; width: 21px;">&nbsp;</td>
                                    <td style="text-align: left; width: 145px;">
                                        <asp:Label ID="Label25" runat="server" Text="Autorizar Visitantes:"></asp:Label>
                                    </td>
                                    <td style="text-align: left">
                                        <asp:CheckBox ID="chkautoriza" runat="server" AutoPostBack="True" />
                                    </td>
                                    <td style="text-align: left">&nbsp;</td>
                                </tr>
                                <tr>
                ...
                <td>
                    <div id="menuaccions" style="border-style: ridge double double ridge; width: 100%; background-color: #FFFFFF; border-top-width: 4px; border-top-color: #FF0000; border-left-color: #FF0000;">
                        <table style="width: 100%">
                            <tr>
                                <td style="width: 1164px">
                                    <asp:ImageButton ID="btningresar" runat="server" Height="60px" ImageUrl="~/Botones/Grabar.png" OnClick="btningresar_Click" />
                                </td>
