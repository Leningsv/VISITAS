<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CaptureImage.aspx.cs" Inherits="Funcionario_WebCam_CaptureImage" %>
...
<%--                            <input type="image" id="capture" onclick="javascript: document.getElementById('Submit').disabled = false;"
    ...
    <script language="javascript" type="text/javascript">
        ...
        function UploadPic() {
            ...
            $.ajax({
                type: 'POST',
                url: "baseimg.aspx?codigofuncio=" + cod_fun,
