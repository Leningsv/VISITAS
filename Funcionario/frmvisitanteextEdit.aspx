<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmvisitanteextEdit.aspx.cs" Inherits="Funcionario_frmvisitanteextEdit" %>
                        ...
                        <ContentTemplate>
                            ...
                            <table style="width: 100%; color:black">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left">
                                        <asp:DropDownList ID="ddltipodoc" runat="server" AutoPostBack="True" Width="267px">
                                        </asp:DropDownList>
                                    </td>
                                    <td style="text-align: left">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left">
                                        <asp:TextBox ID="txtentidad" runat="server" CssClass="upperCase" Width="264px"></asp:TextBox>
                                    </td>
                                    <td style="text-align: left">&nbsp;</td>
                                </tr>
                                <tr>
