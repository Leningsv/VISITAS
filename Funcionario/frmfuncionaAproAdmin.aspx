<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmfuncionaAproAdmin.aspx.cs" Inherits="Funcionario_frmfuncionaAproAdmin" %>
                                ...
                                <td style="width: 100%; text-align:left; background-color:#FFFFFF">
                                    <%--<asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" Width="100%" Height="320px">--%>
                                        <asp:GridView ID="grdvDatos" SkinID="grillamant" runat="server" 
                                                ...
                                                Width="100%" AllowSorting="True" EmptyDataText="No Existen Visitantes Externos Ingresados" 
                                                ForeColor="#333333" CellPadding="2" 
                                                CssClass="Texto_General" AllowPaging="True" DataKeyNames="CodFun,CodVisita,CodEvento" OnPageIndexChanging="grdvDatos_PageIndexChanging" > 
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="VisiExterno" HeaderText="Visitante Externo" >
                                                        <ControlStyle ForeColor="Black" Font-Size="7pt" />
                                                        <HeaderStyle CssClass="GVFixedHeader" />
                                                        <ItemStyle HorizontalAlign="Left" />                                                    
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="Observa" HeaderText="Observación" >
                                                        <ControlStyle ForeColor="Black" Font-Size="7pt" />
                                                        <HeaderStyle CssClass="GVFixedHeader" />
                                                        <ItemStyle HorizontalAlign="Left" />                                                    
                                                    </asp:BoundField>
                                        ...
                                        <table style="width: 100%">
                                            <tr>
                                                <td style="width: 385px">
                                                    <asp:ImageButton ID="btningreso" runat="server" Height="60px" ImageUrl="~/Botones/Nuevo.png" Visible="False"  />
                                                </td>
