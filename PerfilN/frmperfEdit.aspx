<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmperfEdit.aspx.cs" Inherits="PerfilN_frmperfEdit" %>
                ...
                <table runat="server" id="tblprincipal" style="width: 100%;  color: #000000;">
                    ...
                    <tr>
                        <td colspan="2" style="text-align: center; ">
                            <asp:Label ID="lblerror" runat="server" ForeColor="Red" Text="El Nombre del Perfil ingresado ya existe" Visible="False"></asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <tr>
                        <td style="width: 100%; text-align:left; background-color:#FFFFFF">                          
                                    ...
                                    <asp:Panel ID="Panel2" runat="server" ScrollBars="Vertical" Height="320px" Width="100%">                               
                                        <asp:GridView ID="grdvDatos" runat="server" CaptionAlign="Left" BackColor="White" 
                                            EmptyDataText="No Existen Tareas Ingresadas" Width="100%" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" PageSize="100">
                                            <Columns>
