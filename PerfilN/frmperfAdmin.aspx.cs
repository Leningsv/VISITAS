...
public partial class PerfilN_frmperfAdmin : System.Web.UI.Page
{
    #region Variables
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                lbltitulo.Text = "Administrador de Perfil";
    ...
    protected void funCargaMantenimiento()
    {
        ...
        objparam[0] = 0;
        dsData = fun.consultarDatos("spnPerfAdminReadAll", objparam, Page, (String[])Session["constrring"]);
    ...
    {
        Response.Redirect("frmperfNew.aspx");        
    }
    ...
    protected void btnselecc_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Response.Redirect("frmperfEdit.aspx?perfCodigo=" + strCodigoPerf);        
    }
    #endregion
}