<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmpplRelacion.aspx.cs" Inherits="PPL_frmpplRelacion" %>
                                ...
                                <td style="width: 100%; text-align:left; background-color:#FFFFFF">
                                    <asp:Panel ID="Panel1" runat="server" ScrollBars="Vertical" Width="100%" Height="320px">
                                        <asp:GridView ID="grdvDatos" SkinID="grillamant" runat="server" 
                                                ...
                                                <Columns>
                                                    <asp:HyperLinkField DataNavigateUrlFields="URLLINK" DataTextField="Codigo" SortExpression="Codigo" HeaderText="Codigo" Target="_self" >
                                                        <ControlStyle ForeColor="Black" Font-Size="7pt" />
                                                        <HeaderStyle CssClass="GVFixedHeader" />
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:HyperLinkField>
                                                    <asp:HyperLinkField DataNavigateUrlFields="URLLINK" DataTextField="Nombre" SortExpression="Nombre" HeaderText="Nombre">
                                                        <ControlStyle ForeColor="Black" Font-Size="7pt" />
                                                        <HeaderStyle CssClass="GVFixedHeader" />
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:HyperLinkField>
                                                    <asp:HyperLinkField DataNavigateUrlFields="URLLINK" DataTextField="Apellido" SortExpression="Apellido" HeaderText="Apellido">
                                                        <ControlStyle ForeColor="Black" Font-Size="7pt" />
                                                        <HeaderStyle CssClass="GVFixedHeader" />
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:HyperLinkField>
                                                    <asp:HyperLinkField DataNavigateUrlFields="URLLINK" DataTextField="Usuario" SortExpression="Usuario" HeaderText="Usuario">
                                                        <ControlStyle ForeColor="Black" Font-Size="7pt" />
                                                        <HeaderStyle CssClass="GVFixedHeader" />
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:HyperLinkField>
                                                    <asp:HyperLinkField DataNavigateUrlFields="URLLINK" DataTextField="Departamento" SortExpression="Departamento" HeaderText="Departamento">
                                                        <ControlStyle ForeColor="Black" Font-Size="7pt" />
                                                        <HeaderStyle CssClass="GVFixedHeader" />
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:HyperLinkField>
                                                    <asp:HyperLinkField DataNavigateUrlFields="URLLINK" DataTextField="Estatus" SortExpression="Estatus" HeaderText="Estado">
                                                        <ControlStyle ForeColor="Black" Font-Size="7pt" />
                                                        <HeaderStyle CssClass="GVFixedHeader" />
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:HyperLinkField>                                              
                                        ...
                                        <table style="width: 100%">
                                            <tr>
                                                ...
                                                <td style="width:312px">
                                                    <asp:ImageButton ID="btnsalir" runat="server" Height="60px" ImageUrl="~/Botones/Salir.png"  />
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
