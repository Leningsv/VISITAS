<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmAdminRelacion.aspx.cs" Inherits="PPL_frmAdminRelacion" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div style="width: 100%; color: #20365F; font-family: Aparajita; font-size: 25px; font-weight: bold; text-transform: uppercase; text-align: left; text-decoration: underline;">
                <asp:Label ID="Label2" runat="server" Font-Size="12pt">datos ppl</asp:Label>
            </div>
                                ...
                                <td style="width: 100%; text-align:left; background-color:#FFFFFF">   
                                            ...
                                            <asp:GridView ID="grdvDatos" SkinID="grillamant" runat="server" 
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:HyperLinkField DataNavigateUrlFields="URLLINK" DataTextField="NumDocu" HeaderText="Num. Documento">
                                                        <ControlStyle ForeColor="Black" Font-Size="7pt" />
                                                        <HeaderStyle CssClass="GVFixedHeader" />
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:HyperLinkField>
                                                    <asp:HyperLinkField DataNavigateUrlFields="URLLINK" HeaderText="Nombres" DataTextField="Nombres" >
                                                        <ControlStyle ForeColor="Black" Font-Size="7pt" />
                                                        <HeaderStyle CssClass="GVFixedHeader" />
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:HyperLinkField>
                                                    ...
                                                    <asp:HyperLinkField DataNavigateUrlFields="URLLINK" DataTextField="Pabellon" HeaderText="Pabellón" >
                                                        <ControlStyle ForeColor="Black" Font-Size="7pt" />
                                                        <HeaderStyle CssClass="GVFixedHeader" />
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:HyperLinkField>
