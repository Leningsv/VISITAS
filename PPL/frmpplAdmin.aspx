<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmpplAdmin.aspx.cs" Inherits="PPL_frmpplAdmin" %>
...
<%--                                    <asp:UpdatePanel ID="uppbuscagrilla" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>     
                                            ...
                                            <asp:GridView ID="grdvDatos" SkinID="grillamant" runat="server" 
                                                ...
                                                ForeColor="#333333" CellPadding="4" PageSize="15" CssClass="Texto_General" AllowPaging="True" OnPageIndexChanging="grdvDatos_PageIndexChanging"  > 
                                                <Columns>
                                                    ...
                                                    <asp:HyperLinkField DataNavigateUrlFields="URLLINK" HeaderText="Nombres PPL" DataTextField="PPL" >
                                                        <ControlStyle ForeColor="Black" Font-Size="7pt" />
                                                        <HeaderStyle CssClass="GVFixedHeader" />
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:HyperLinkField>
