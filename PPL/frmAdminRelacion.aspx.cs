...
public partial class PPL_frmAdminRelacion : System.Web.UI.Page
{
    #region Variables
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                lbltitulo.Text = "relación ppl - Visitantes";
    ...
    protected void funCargaMantenimiento()
    {
        ...
        objparam[0] = 0;
        dsData = fun.consultarDatos("spPPLRelacVisita", objparam, Page, (String[])Session["constrring"]);
