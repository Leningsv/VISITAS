<%@ Page Title="" Language="C#" MasterPageFile="~/Mantenimientos.master" AutoEventWireup="true" CodeFile="frmpplNew.aspx.cs" Inherits="PPL_frmpplNew" %>
                            ...
                            <table style="width: 100%; color:black">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left">
                                        ...
                                        <asp:FilteredTextBoxExtender ID="txtcelda_FilteredTextBoxExtender" runat="server" Enabled="True" FilterType="Numbers" TargetControlID="txtcelda">
                                        </asp:FilteredTextBoxExtender>
                                    </td>
                                    <td style="text-align: left">
